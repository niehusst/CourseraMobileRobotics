...
% see the LICENSE file included with this software
    ...
    methods
        ...
        function outputs = execute(obj, robot, state_estimate, inputs, dt)
            ...
            % convert wf distances to rf?
            %ir_distances_rf = 
            
            sensor_gains = [3 2 1 2 3]; %1 2 3 2 1
            u_i = (ir_distances_wf - [x;y]) .* sensor_gains;  
            u_ao = sum(u_i,2); %sum vectors
            u_ao
...
%             fprintf('(v,w) = (%0.4g,%0.4g)\n', v,w);
        ...
        function ir_distances_wf = apply_sensor_geometry(obj, ir_distances, state_estimate)
            ...
            ir_distances_rf = zeros(3,n_sensors); %allocate space
            for i=1:n_sensors
            ...
            R_w = obj.get_transformation_matrix(x,y,theta);
            ir_distances_wf = R_w * ir_distances_rf;
            
            %% END CODE BLOCK %%
            
            % strip last meaningless row
